        ...
        <div class="row">
            <div class="col-lg-4 offset-lg-4">
                <div class="card">
                    ...
                    <div class="card-header text-center fs-4">Account Details...!!</div>

                    <div class="card-body">
                        <form action="updatecustomerdetail.php" id="myForm" method="post">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Name</label>
                                <input type="text" class="form-control" id="name" aria-describedby="emailHelp"
                                    name="name" value="<?php echo $cname ; ?>" required readonly>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Email address</label>
                                <input type="email" class="form-control" id="email" aria-describedby="emailHelp"
                                    name="email"  value="<?php echo $cemail ; ?>" required readonly>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Phone</label>
                                <input type="number" class="form-control" name="phone" id="phone"  value="<?php echo $cphone ; ?>"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '').substring(0, 10)" required readonly>
                            </div>
                            <!-- <div class="mb-3">
                            ...
                            <div class="d-grid gap-2">
                                <input class="btn btn-success fs-5" type="submit" value="Update Detail">
